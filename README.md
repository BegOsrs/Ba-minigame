...
The features from the barbarian assault plugin are automatically turned off. And then restored when this plugin is turn off.

# Ba minigame Configuration

![Barbarian assault plugin](https://i.imgur.com/afEEEfW.gif) 
...
### Highlight eggs
Highlight collectorEgg colors on the ground
